...
public class BasicOpMode extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            brPower = Range.clip(drive+strafe-spin, -1.0, 1.0);
            blPower = Range.clip(drive-strafe+spin+turn, -1.0, 1.0);
            frPower = Range.clip(drive-strafe-spin, -1.0, 1.0);
            flPower = Range.clip(drive+strafe+spin+turn, -1.0, 1.0);
